...
kernel.bin:
	...
	$(CC) -x assembler-with-cpp  $(CFLAGS) -mcpu=$(CPU_CC) -c  lab1.S -o lab1.o
	$(CC) -x assembler-with-cpp  $(CFLAGS) -mcpu=$(CPU_CC) -c  lab2.S -o lab2.o
	$(CC) -mcpu=$(CPU_CC) $(LDFLAGS) -T./lscript_kernel.ld -o kernel.elf kernel.o print.o lab1.o lab2.o $(INCFLAGS)
